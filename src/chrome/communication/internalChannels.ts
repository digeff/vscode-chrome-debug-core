...
import { IActionToTakeWhenPaused } from './collaborativeDecision';
import { PausedEvent } from '../cdtpDebuggee/eventsProviders/cdtpDebuggeeExecutionEventsProvider';

const _breakpoints = {
    // Notifications
    OnUnbounBPRecipeIsNowBound: new NotificationChannelIdentifier<BPRecipe<ScriptOrSourceOrURLOrURLRegexp>>(),
    OnPausedOnBreakpoint: new NotificationChannelIdentifier<PausedEvent, IActionToTakeWhenPaused<void>>(),
