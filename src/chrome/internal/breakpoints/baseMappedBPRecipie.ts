...
import { NativelySupportedHitActions } from './nativeSupport';
...
export class BPRecipieInScript extends BaseMappedBPRecipie<IScript, NativelySupportedHitActions> {
...
export class BPRecipieInUrl extends BaseMappedBPRecipie<IURL<CDTPScriptUrl>, NativelySupportedHitActions> { }
export class BPRecipieInUrlRegexp extends BaseMappedBPRecipie<URLRegexp, NativelySupportedHitActions> { }
