...
export class BreakpointsUpdater {
    ...
    private readonly _breakpointsInLoadedSource = new BPRecipeAtLoadedSourceLogic(this._breakpointsEventSystem, this._breakpointFeaturesSupport, this._breakpointsSetForScriptFinder, this._debuggeeBPRsSetForClientBPRFinder,
