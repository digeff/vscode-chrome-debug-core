...
import { NativelySupportedHitActions, NativelySupportedResources } from './nativeSupport';
...
export class MappableBreakpoint<TResource extends NativelySupportedResources> extends BaseBreakpoint<TResource> {
    ...
    constructor(public readonly recipie: IMappedBPRecipie<TResource, NativelySupportedHitActions>, public readonly actualLocation: ActualLocation<TResource>) {
        super();
    }
}
