...
import { IFutureScript } from './IFutureScript';

export interface ISourceToScriptMapper<T extends IFutureScript = IFutureScript> {
...
export interface ISourceMapper<T extends IFutureScript = IFutureScript> extends ISourceToScriptMapper<T>, IScriptToSourceMapper { }

export interface IMappedSourcesMapper<T extends IFutureScript = IFutureScript> extends ISourceMapper<T> {
...
export class MappedSourcesMapper<T extends IFutureScript = IFutureScript> implements IMappedSourcesMapper<T> {
