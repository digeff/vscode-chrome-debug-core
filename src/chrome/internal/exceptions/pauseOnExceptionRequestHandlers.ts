...
import { ExceptionStackTracePrintter } from './exceptionStackTracePrintter';
    ...
    private toExceptionInfo(info: IExceptionInformation): IExceptionInfoResponseBody {
        return {
            ...
            details: {
                ...
                stackTrace: this._exceptionStackTracePrintter.toExceptionStackTracePrintted(info.details.stackTrace),
