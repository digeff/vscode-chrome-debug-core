...
function bind<T>(container: Container, serviceIdentifier: interfaces.ServiceIdentifier<T>, newable: interfaces.Newable<T>): void {
    container.bind<T>(serviceIdentifier).to(newable).inSingletonScope();
}
