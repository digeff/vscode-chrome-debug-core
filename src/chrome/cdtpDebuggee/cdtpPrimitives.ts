...
import { IMappedBPRecipe } from '../internal/breakpoints/baseMappedBPRecipe';
...
export type CDTPBPRecipe = IMappedBPRecipe<CDTPSupportedResources, CDTPSupportedHitActions>;
